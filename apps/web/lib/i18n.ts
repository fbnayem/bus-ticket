...
const S = {
  ...
  'ticket.resend':         { en: 'Resend to my phone',        bn: 'আমার ফোনে আবার পাঠান' },
  'ticket.resending':      { en: 'Sending…',                 bn: 'পাঠানো হচ্ছে…' },
  'ticket.resent':         { en: 'Ticket sent to your number again.', bn: 'আপনার নম্বরে টিকিট আবার পাঠানো হয়েছে।' },
  'ticket.copied':         { en: 'Copied',                   bn: 'কপি হয়েছে' },
  'ticket.copyFailed':     { en: 'Could not copy',           bn: 'কপি করা যায়নি' },

  /* ------------------------------------------------------------ VAT invoice */
  'inv.link':        { en: 'VAT invoice',                bn: 'মূসক চালান' },
  'inv.title':       { en: 'VAT Invoice',                bn: 'মূসক চালানপত্র' },
  'inv.mushak':      { en: 'Mushak 6.3',                 bn: 'মূসক ৬.৩' },
  'inv.no':          { en: 'Invoice no.',                bn: 'চালান নম্বর' },
  'inv.issued':      { en: 'Issued',                     bn: 'ইস্যু' },
  'inv.seller':      { en: 'Seller',                     bn: 'বিক্রেতা' },
  'inv.buyer':       { en: 'Buyer',                      bn: 'ক্রেতা' },
  'inv.bin':         { en: 'BIN',                        bn: 'বিআইএন' },
  'inv.journey':     { en: 'Journey',                    bn: 'যাত্রা' },
  'inv.desc':        { en: 'Description',                bn: 'বিবরণ' },
  'inv.transport':   { en: 'Bus fare',                   bn: 'বাস ভাড়া' },
  'inv.base':        { en: 'Value (excl. VAT)',          bn: 'মূল্য (মূসক ছাড়া)' },
  'inv.vat':         { en: 'VAT',                        bn: 'মূসক' },
  'inv.exempt':      { en: 'VAT-exempt (non-AC transport)', bn: 'মূসক অব্যাহতি (নন-এসি পরিবহন)' },
  'inv.fareTotal':   { en: 'Fare total (incl. VAT)',     bn: 'ভাড়া মোট (মূসকসহ)' },
  'inv.platformFee': { en: 'Platform service fee',       bn: 'প্ল্যাটফর্ম সার্ভিস ফি' },
  'inv.platformNote': { en: 'Charged by Jatra, separate from the operator VAT invoice.', bn: 'যাত্রা কর্তৃক গৃহীত, অপারেটরের কর চালান থেকে পৃথক।' },
  'inv.discount':    { en: 'Discount',                   bn: 'ছাড়' },
  'inv.grandTotal':  { en: 'Total paid',                 bn: 'মোট পরিশোধিত' },
  'inv.print':       { en: 'Print',                      bn: 'প্রিন্ট' },
  'inv.derived':     { en: 'A computer-generated tax invoice. VAT is included in the fare and shown for disclosure.', bn: 'কম্পিউটার-জেনারেটেড কর চালান। ভাড়ায় মূসক অন্তর্ভুক্ত, এখানে তা দেখানো হলো।' },
  ...
  'co.concession':         { en: 'Concession',               bn: 'ছাড়' },
  'co.fullFare':           { en: 'Full fare',                bn: 'পূর্ণ ভাড়া' },
  'co.concessionLine':     { en: 'Concession',               bn: 'ছাড়' },
  ...
  'co.manage.title':    { en: 'Manage a ticket',        bn: 'টিকিট ব্যবস্থাপনা' },
  'co.manage.hint':     { en: 'Reprint a ticket, or refund a cash sale from the drawer.', bn: 'টিকিট পুনরায় প্রিন্ট করুন, বা ড্রয়ার থেকে নগদ বিক্রির ফেরত দিন।' },
  'co.manage.pnr':      { en: 'PNR',                     bn: 'পিএনআর' },
  'co.manage.lookup':   { en: 'Look up',                 bn: 'খুঁজুন' },
  'co.manage.reprint':  { en: 'Reprint',                 bn: 'পুনরায় প্রিন্ট' },
  'co.manage.refund':   { en: 'Refund',                  bn: 'ফেরত' },
  'co.manage.reason':   { en: 'Reason for refund',       bn: 'ফেরতের কারণ' },
  'co.manage.needReason': { en: 'Give a reason first.',  bn: 'আগে একটি কারণ লিখুন।' },
  'co.manage.quote':    { en: 'Refund {amount} of {total} ({pct}%) — the rest is the cancellation fee.', bn: '{total} এর মধ্যে {amount} ফেরত ({pct}%) — বাকিটা বাতিলের ফি।' },
  'co.manage.confirm':  { en: 'Pay refund from drawer',  bn: 'ড্রয়ার থেকে ফেরত দিন' },
  'co.manage.refunded': { en: 'Refunded {amount} in cash.', bn: 'নগদ {amount} ফেরত দেওয়া হয়েছে।' },
  'co.manage.reprinted':{ en: 'Ticket reprinted.',       bn: 'টিকিট পুনরায় প্রিন্ট হয়েছে।' },
  'co.manage.notCash':  { en: 'Only a cash counter sale can be refunded here.', bn: 'শুধু নগদ কাউন্টার বিক্রির ফেরত এখানে দেওয়া যায়।' },
